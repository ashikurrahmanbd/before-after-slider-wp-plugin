    ...
    return (function (t) {
        ...
        function (t, e, n) {
            ...
            t.exports = function (t, e, n, v, g, m, x) {
                ...
                if (
                    (L && ((b = i(L.call(new t()))), d !== Object.prototype && b.next && (f || i(b) === d || (c ? c(b, d) : "function" != typeof b[l] && a(b, l, y)), u(b, O, !0, !0), f && (p[O] = y))),
                    "values" == g &&
                        T &&
                        "values" !== T.name &&
                        ((P = !0),
                    ...
                    if (((j = { values: w("values"), keys: m ? _ : w("keys"), entries: w("entries") }), x)) for (S in j) (!h && !P && S in E) || s(E, S, j[S]);
        ...
        function (t, e, n) {
            ...
            var r,
                                        ...
                                        try {
                                            a
                                                ? (i || (2 === e.rejection && U(t, e), (e.rejection = 1)),
                                                  !0 === a ? (r = o) : (l && l.enter(), (r = a(o)), l && (l.exit(), (u = !0))),
                                                  r === n.promise ? f(M("Promise-chain cycle")) : (c = N(r)) ? c.call(r, s, f) : s(r))
                                                : f(o);
                                        } catch (t) {
                                            l && !u && l.exit(), f(t);
                                        }
                ...
                W = function (t, e, n) {
                    var r, o;
                    D ? (((r = I.createEvent("Event")).promise = e), (r.reason = n), r.initEvent(t, !1, !0), a.dispatchEvent(r)) : (r = { promise: e, reason: n }),
